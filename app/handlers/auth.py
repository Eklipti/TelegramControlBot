...
class AllowedUserFilter(BaseFilter):
    ...
    async def __call__(self, obj: Message | CallbackQuery) -> bool:
        ...
        if not is_allowed:
            ...
            trace(
                f"Детали неавторизованного доступа: user_id={user.id},"
                f" username={username}, first_name={user.first_name}, last_name={user.last_name}",
                "auth",
            )
            ...
            trace(
                f"Детали авторизованного доступа: user_id={user.id},"
                f" username={username}, first_name={user.first_name}, last_name={user.last_name}",
                "auth",
            )
