...
Обрабатывает подтверждения опасных действий и фильтры доступа
"""
...
class PrivateChatFilter(BaseFilter):
    ...
    async def __call__(self, obj: Message | CallbackQuery) -> bool:
        ...
        # Для callback-запросов
            ...
            return obj.message and obj.message.chat.type == ChatType.PRIVATE
...
class ConfirmationManager:
    ...
    async def create_confirmation(
        ...
        message_text = f"⚠️ <b>ВНИМАНИЕ! Опасное действие</b>\n\n{warning_message}\n\n" \
